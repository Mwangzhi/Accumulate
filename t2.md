...
### 为什么离开公司：
技术方面：技术总体陈旧、不拥抱变化、于我个人来说，学到的技术得不到落地。成长很慢
环境方面：按部就班的工作，缺少活力，没有尝试创新环境，长此以往，可能会思维退化。
...
开发cli，内部集成模板，加快了开发效率
开发vue插件，业务权限验证插件
开发了捕获try()catch(){}错误的babel插件
权限树，虚拟列表渲染。

### 项目亮点：

项目遇到的问题：
1、sql不会写，无法查、增加、修改数据
2、前端框架旧技术，没有模块化划分，js文件达到万行，维护不便。
3、权限树因数据量太大，加载缓慢或者卡死，虚拟列表解决。

### 自己的贡献：
1、开发模板脚手架，提高开发效率
2、基于elementui，开发公司业务组件库
